...
private val benchmarkLogger = System.getLogger("dole.bench")
...
internal actual fun logBenchmark(message: String) {
    benchmarkLogger.log(System.Logger.Level.INFO, message)
}
...
internal actual object NativeCore {
    ...
    actual fun benchGenerateTransactions(): List<NativeLedgerTransaction> =
        dole.core.benchGenerateTransactions().map { it.toNative() }
}
